...
const SUB_PATH = process.env.SUB_PATH || 'xuanlonghuanmeng';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '018b61d9-c602-45e1-a9eb-708a0113bc63'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
